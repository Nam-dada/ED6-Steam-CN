...
def func_09_59D0():
    ...
    ChrTalk(
        0x0016,
        (
            '#0270390723V#140F呼，船的修理作业\n',
            '总算也得以顺利进行了。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0270390724V要是能阻止结社的阴谋，\n',
            '那真是个完美的结局啊。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0270390725V#141F我们这些记者\n',
            '也很希望能够确实\n',
            '做好自己的工作嘛',
            TxtCtl.Enter,
            TxtCtl.Clear,
...
def func_13_ACF3():
    ...
    ChrTalk(
        0x0015,
        (
            '#0110401265V#272F#6P『中枢塔』……\n',
            '似乎是整合都市机能\n',
            '的一个地方。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0110401266V#270F『辉之环』，还有\n',
            '我们的敌人一定\n',
            '都在那边吧。',
            TxtCtl.Enter,
        ),
    ...
    ChrTalk(
        0x000C,
        (
            '#0100401267V#176F#3P…………好。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0100401268V#178F我也加入探索吧。',
            TxtCtl.Enter,
        ),
    )
    ...
    ChrTalk(
        0x000C,
        (
            '#0100401275V#171F#3P呵呵，大型的作业\n',
            '大致上都处理好了。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0100401276V#170F至于飞翔机关的测试，\n',
            '我也下达必要的指示了。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0100401277V接下来只要交给博士和船员们，\n',
            '应该就没问题了。',
            TxtCtl.Enter,
        ),
    )
    ...
    ChrTalk(
        0x0101,
        (
            '#0010401278V#1011F#6P这、这样啊……',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0010401279V#1006F嗯，有尤莉亚小姐\n',
            '助我们一臂之力，\n',
            '真是令人信心大增！',
            TxtCtl.Enter,
        ),
    ...
    ChrTalk(
        0x0015,
        (
            '#0110401283V#272F#6P这附近应该已经\n',
            '可以确保安全无虞了。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0110401284V既然如此，我就算待在这里，\n',
            '可以做的事情也有限。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0110401285V#277F请容我以军人的身份\n',
            '助各位一臂之力。',
            TxtCtl.Enter,
        ),
    )
    ...
    ChrTalk(
        0x0104,
        (
            '#0040401286V#31F#2P原来如此……',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0040401287V#37F其实是因为尤莉亚小姐出去的话，\n',
            '你会很寂寞对吧？',
            TxtCtl.Enter,
        ),
    )
    ...
    ChrTalk(
        0x0015,
        (
            '#0110401293V#277F#6P……就是这么一回事。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0110401294V需要我们帮忙的时候\n',
            '就随时说一声。',
            TxtCtl.Enter,
        ),
    )
