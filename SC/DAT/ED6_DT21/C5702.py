...
@scena.Code('func_01_317')
def func_01_317():
    OP_16(0x02, 4000, -54000, -242000, 2293878)
    ...
    LoadChip('ED6_DT26/CH20501._CH', 'ED6_DT26/CH20501P._CP', 9)
...
def func_02_461():
    ...
    ChrSetPos(0x0008, 37090, 16000, -74080, 135)
    ChrSetPos(0x0009, 40420, 16000, -76420, 270)
    ChrSetPos(0x000A, 37590, 16000, -77170, 0)
    ChrClearFlags(0x0008, 0x0080)
    ChrClearFlags(0x0009, 0x0080)
    ChrClearFlags(0x000A, 0x0080)
    CreateThread(0x0008, 0x00, 0x06, func_02_461)
    CreateThread(0x0009, 0x00, 0x06, func_02_461)
    CreateThread(0x000A, 0x00, 0x06, func_02_461)
    ...
    def lambda_0570():
        CameraMove(62050, 16000, -34780, 10000)
    ...
    Fade(500)
    OP_11(0xAA, 0xC8, 0xFF, 75000, 240000, 0)
    CameraMove(37580, 16000, -75050, 0)
    ...
    ChrSetPos(0x0101, 65519, 16000, -92680, 315)
    ChrSetPos(0x0102, 65540, 16000, -94040, 315)
    ChrSetPos(0x00F8, 67240, 16000, -92700, 315)
    ChrSetPos(0x00F9, 67200, 16000, -94120, 315)
    ...
    ChrSetPos(0x010B, 65519, 16000, -92680, 315)
    ChrSetPos(0x0101, 65540, 16000, -94040, 315)
    ChrSetPos(0x0102, 67240, 16000, -92700, 315)
    ...
    ChrSetPos(0x00F8, 67200, 16000, -94120, 315)
    ...
    def lambda_090C():
        CameraMove(64690, 16000, -92130, 5000)
    ...
    OP_6C(294000, 5000)
    Fade(500)
    CameraMove(65129, 16000, -94170, 0)
    ...
    ChrSetPos(0x0101, 65519, 16000, -92680, 270)
    ChrSetPos(0x0102, 65540, 16000, -94040, 0)
    ChrSetPos(0x00F8, 67240, 16000, -92700, 270)
    ChrSetPos(0x00F9, 67200, 16000, -94120, 0)
    ...
    ChrSetPos(0x010B, 65519, 16000, -92680, 270)
    ChrSetPos(0x0101, 65540, 16000, -94040, 0)
    ChrSetPos(0x0102, 67240, 16000, -92700, 270)
    ...
    ChrSetPos(0x00F9, 67200, 16000, -94120, 270)
    ...
    ChrSetPos(0x00F8, 67200, 16000, -94120, 0)
    ...
    FadeOut(1000, 0, -1)
    OP_0D()
    CameraMove(74210, 16000, -100620, 0)
    OP_67(0, 6500, -10000, 0)
    CameraSetDistance(5000, 0)
    OP_6C(315000, 0)
    OP_6E(262, 0)
    ChrSetPos(0x0000, 74210, 16000, -100620, 180)
    ChrSetPos(0x0001, 74210, 16000, -100620, 180)
    ChrSetPos(0x0002, 74210, 16000, -100620, 180)
    ChrSetPos(0x0003, 74210, 16000, -100620, 180)
    Sleep(500)
...
def func_03_1DB0():
    ...
    SetScenaFlags(ScenaFlag(0x045A, 4, 0x22D4))
    Fade(500)
    CameraMove(74330, 16000, -99550, 0)
    OP_67(0, 6500, -10000, 0)
    CameraSetDistance(3800, 0)
    OP_6C(315000, 0)
    OP_6E(262, 0)
    ChrSetPos(0x0102, 74210, 16000, -98340, 180)
    ChrSetPos(0x0101, 74330, 16000, -100940, 0)
    ChrSetPos(0x00F8, 72760, 16000, -100170, 45)
    ChrSetPos(0x00F9, 75790, 16000, -100350, 315)
    OP_0D()
    Sleep(500)
...
def func_05_2D7E():
    ...
    LoadChip('ED6_DT27/CH04610._CH', 'ED6_DT27/CH04610P._CP', 6)
    LoadChip('ED6_DT27/CH04614._CH', 'ED6_DT27/CH04614P._CP', 8)
    LoadChip('ED6_DT27/CH04000._CH', 'ED6_DT27/CH04000P._CP', 10)
    LoadChip('ED6_DT27/CH04001._CH', 'ED6_DT27/CH04001P._CP', 11)
    LoadChip('ED6_DT27/CH04010._CH', 'ED6_DT27/CH04010P._CP', 12)
    LoadChip('ED6_DT27/CH04011._CH', 'ED6_DT27/CH04011P._CP', 13)
    ...
    LoadChip('ED6_DT27/CH04611._CH', 'ED6_DT27/CH04611P._CP', 18)
    LoadChip('ED6_DT27/CH04620._CH', 'ED6_DT27/CH04620P._CP', 19)
    LoadChip('ED6_DT27/CH04621._CH', 'ED6_DT27/CH04621P._CP', 20)
    ...
    OP_4A(0x0009, 255)
    OP_4A(0x000A, 255)
    ChrSetPos(0x0101, 52000, 16000, -80320, 270)
    ChrSetPos(0x0102, 53880, 16000, -80190, 270)
    ChrSetPos(0x010B, 54210, 16000, -82160, 270)
    ChrSetPos(0x00F9, 56010, 16000, -82070, 270)
    Sleep(1000)
    ...
    ChrSetPos(0x0015, 40620, 16000, -75270, 0)
    OP_20(0x000003E8)
    ...
    ChrJumpTo(0x0009, 39020, 16000, -76030, 100, 7000)
    ...
    CreateThread(0x0008, 0x01, 0x00, func_07_386A)
    Sleep(100)

    CreateThread(0x000A, 0x01, 0x00, func_08_3881)
    ...
    def lambda_3261():
        CameraMove(41870, 16000, -75460, 1500)
    ...
    CreateThread(0x0101, 0x00, 0x00, func_0A_38D9)
    CreateThread(0x0102, 0x00, 0x00, func_0B_38F5)
    CreateThread(0x00F9, 0x00, 0x00, func_0D_392D)
    CreateThread(0x010B, 0x00, 0x00, func_0C_3911)
    CreateThread(0x0009, 0x01, 0x00, func_09_3898)
    ...
    def lambda_33F8():
        CameraMove(42000, 16000, -76180, 350)
    ...
    def lambda_3438():
        ChrMoveTo(0x00FE, 43650, 16000, -77880, 8000, 0x00)
    ...
    def lambda_3458():
        ChrMoveTo(0x00FE, 43730, 16000, -76620, 8000, 0x00)
    ...
    def lambda_347D():
        ChrMoveTo(0x00FE, 44040, 16000, -77600, 8000, 0x00)
    ...
    ChrSetChipByIndex(0x0009, 18)
    ChrSetFlags(0x0009, 0x1000)

    @scena.Lambda('lambda_34A7')
    def lambda_34A7():
        ChrMoveTo(0x00FE, 42670, 16000, -77000, 8000, 0x00)
    ...
    def lambda_34C2():
        ChrMoveTo(0x00FE, 45250, 16000, -78600, 8000, 0x00)
    ...
    def lambda_34EC():
        ChrMoveTo(0x00FE, 42880, 16000, -77510, 8000, 0x00)
    ...
    def lambda_3507():
        ChrMoveTo(0x00FE, 45090, 16000, -76480, 8000, 0x00)
...
def func_06_355C():
    ...
    CameraMove(38850, 16000, -75750, 0)
    ...
    ChrSetPos(0x0101, 39540, 16000, -77330, 270)
    ChrSetPos(0x0102, 39390, 16000, -75710, 270)
    ChrSetPos(0x010B, 41200, 16000, -77800, 270)
    ChrSetPos(0x00F9, 41070, 16000, -75780, 270)
    ChrClearFlags(0x0008, 0x0080)
    ChrClearFlags(0x0009, 0x0080)
    ChrClearFlags(0x000A, 0x0080)
    ChrSetPos(0x0008, 37040, 16000, -74990, 0)
    ChrSetPos(0x0009, 35310, 16000, -76550, 0)
    ChrSetPos(0x000A, 37100, 16000, -78080, 0)
    ChrSetChipByIndex(0x0101, 10)
    ChrSetChipByIndex(0x0102, 12)
    ChrSetChipByIndex(0x010B, 14)
    ChrSetChipByIndex(0x00F9, 16)
    ...
    def lambda_37C8():
        CameraMove(34850, 16500, -55030, 5000)
    ...
    CreateThread(0x0102, 0x01, 0x00, func_0F_3979)
    Sleep(100)

    CreateThread(0x0101, 0x01, 0x00, func_0E_3949)
    Sleep(400)

    CreateThread(0x00F9, 0x01, 0x00, func_10_39A9)
    Sleep(50)

    CreateThread(0x010B, 0x01, 0x00, func_11_39D9)
...
def func_0A_38D9():
    ...
    ChrMoveTo(0x00FE, 47430, 16000, -78190, 5000, 0x00)
...
def func_0B_38F5():
    ChrSetDirection(0x00FE, 270, 0)
    ChrMoveTo(0x00FE, 47480, 16000, -76830, 5000, 0x00)
...
def func_0C_3911():
    ChrSetDirection(0x00FE, 270, 0)
    ChrMoveTo(0x00FE, 49130, 16000, -79020, 5000, 0x00)
...
def func_0D_392D():
    ChrSetDirection(0x00FE, 270, 0)
    ChrMoveTo(0x00FE, 49190, 16000, -77210, 5000, 0x00)
...
def func_0E_3949():
    ...
    ChrWalkTo(0x00FE, 37300, 16000, -69520, 7000, 0x00)
    ChrWalkTo(0x00FE, 37300, 16500, -29190, 7000, 0x00)
...
def func_0F_3979():
    ChrSetDirection(0x00FE, 0, 600)
    ChrWalkTo(0x00FE, 38350, 16000, -69530, 7000, 0x00)
    ChrWalkTo(0x00FE, 38350, 16500, -29190, 7000, 0x00)
...
def func_10_39A9():
    ChrSetDirection(0x00FE, 0, 600)
    ChrWalkTo(0x00FE, 39800, 16000, -69530, 7000, 0x00)
    ChrWalkTo(0x00FE, 39800, 16500, -29190, 7000, 0x00)
...
def func_11_39D9():
    ChrSetDirection(0x00FE, 0, 600)
    ChrWalkTo(0x00FE, 38500, 16000, -69530, 7000, 0x00)
    ChrWalkTo(0x00FE, 38500, 16500, -29190, 7000, 0x00)
...
def func_12_3A09():
    ...
    LoadChip('ED6_DT27/CH04001._CH', 'ED6_DT27/CH04001P._CP', 10)
    LoadChip('ED6_DT27/CH04011._CH', 'ED6_DT27/CH04011P._CP', 11)
    ...
    LoadChip('ED6_DT07/CH00171._CH', 'ED6_DT07/CH00171P._CP', 13)
    ...
    CameraMove(37920, 16500, -35740, 0)
    OP_67(0, 7220, -10000, 0)
    CameraSetDistance(4870, 0)
    OP_6C(335000, 0)
    OP_6E(351, 0)
    ChrSetPos(0x0101, 36980, 16500, -28010, 90)
    ChrSetPos(0x0102, 38630, 16500, -28010, 90)
    ChrSetPos(0x010B, 36980, 16500, -28010, 90)
    ChrSetPos(0x00F9, 38630, 16500, -28010, 90)
    ChrSetPos(0x000C, 37670, 16500, -28010, 90)
    ChrSetPos(0x000B, 38190, 16500, -28010, 90)
    ChrSetPos(0x000D, 39700, 16500, -28010, 90)
    ChrSetPos(0x000E, 38470, 16500, -28010, 90)
    ChrSetPos(0x000F, 36850, 16500, -28010, 90)
    ChrSetPos(0x0010, 39500, 16500, -28010, 90)
    ChrSetPos(0x0011, 36170, 16500, -28010, 90)
    ChrSetPos(0x0012, 37760, 16500, -28010, 90)
    ChrSetChipByIndex(0x0101, 10)
    ...
    ChrSetFlags(0x010B, 0x1000)
    ChrSetFlags(0x00F9, 0x1000)
    CreateThread(0x0101, 0x01, 0x00, func_13_3C9C)
    FadeIn(1000, 0)
    Sleep(1000)

    @scena.Lambda('lambda_3C15')
    def lambda_3C15():
        CameraMove(35620, 16500, -53400, 5000)
...
def func_13_3C9C():
    CreateThread(0x0101, 0x02, 0x00, func_14_3D28)
    Sleep(50)

    CreateThread(0x0102, 0x01, 0x00, func_14_3D28)
    Sleep(400)

    CreateThread(0x010B, 0x01, 0x00, func_14_3D28)
    Sleep(80)

    CreateThread(0x00F9, 0x01, 0x00, func_14_3D28)
    Sleep(300)

    CreateThread(0x000C, 0x01, 0x00, func_14_3D28)
    Sleep(400)

    CreateThread(0x000B, 0x01, 0x00, func_14_3D28)
    Sleep(500)

    CreateThread(0x000D, 0x01, 0x00, func_14_3D28)
    Sleep(200)

    CreateThread(0x000E, 0x01, 0x00, func_14_3D28)
    Sleep(300)

    CreateThread(0x000F, 0x01, 0x00, func_14_3D28)
    Sleep(400)

    CreateThread(0x0010, 0x01, 0x00, func_14_3D28)
    Sleep(300)

    CreateThread(0x0011, 0x01, 0x00, func_14_3D28)
    Sleep(200)

    CreateThread(0x0012, 0x01, 0x00, func_14_3D28)
...
def func_14_3D28():
    ...
    ChrMoveToRelative(0x00FE, 0, 0, -80000, 7000, 0x00)
...
def func_16_3DCE():
    FadeOut(0, 0, -1)
    CameraMove(-344380, 4000, -855980, 0)
    OP_67(0, 6500, -10000, 0)
    CameraSetDistance(5000, 0)
    OP_6C(315000, 0)
    OP_6E(262, 0)
