...
def func_02_218():
    ...
    CreateThread(0x0101, 0x01, 0x00, func_03_1632)
    Sleep(500)

    CreateThread(0x0102, 0x01, 0x00, func_04_1669)
    Sleep(500)

    CreateThread(0x00F8, 0x01, 0x00, func_05_16A0)
    Sleep(500)

    CreateThread(0x00F9, 0x01, 0x00, func_06_16D7)
    OP_73(0x0001)
    OP_23(0x013E)
    WaitForThreadExit(0x0101, 0x0000)
    OP_6F(0x0001, 800)
    ...
    SetScenaFlags(ScenaFlag(0x0440, 7, 0x2207))
...
def func_07_170E():
    ...
    SetScenaFlags(ScenaFlag(0x0442, 1, 0x2211))
    SetScenaFlags(ScenaFlag(0x0442, 4, 0x2214))
    CreateThread(0x0101, 0x01, 0x00, func_08_1E47)
...
def func_08_1E47():
    ...
    OP_5F(0x0000)
    CreateThread(0x0101, 0x02, 0x00, func_09_1F3F)
    Sleep(800)

    CreateThread(0x0102, 0x01, 0x00, func_09_1F3F)
    Sleep(800)

    CreateThread(0x00F8, 0x01, 0x00, func_09_1F3F)
    Sleep(800)

    CreateThread(0x00F9, 0x01, 0x00, func_09_1F3F)
    Sleep(1500)
...
def func_0A_1F93():
    ...
    CreateThread(0x0101, 0x01, 0x00, func_0B_2AF6)
    Sleep(800)

    CreateThread(0x0102, 0x01, 0x00, func_0C_2B4D)
    Sleep(800)
    ...
    CreateThread(0x00F8, 0x01, 0x00, func_0D_2B9F)
    Sleep(800)

    CreateThread(0x00F9, 0x01, 0x00, func_0E_2BF1)
