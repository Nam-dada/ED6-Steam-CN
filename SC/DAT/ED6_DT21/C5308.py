...
def func_04_3AF():
    ...
    ChrTalk(
        0x010F,
        (
            '#0100410055V#178F（……是出现在翡翠之塔的那个男人吗……）',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0100410056V#176F（听说他多次\n',
            '  出现在殿下面前……）',
            TxtCtl.Enter,
        ),
    )
    ...
    ChrTalk(
        0x010F,
        (
            '#0100410068V#176F欢迎，吗……',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0100410069V#172F……下来吧。\n',
            '我就在这里了结你。',
            TxtCtl.Enter,
        ),
    )
    ...
    ChrTalk(
        0x0105,
        (
            '#0060410070V#1165F（尤莉亚大人，看来她是认真的……）',
            TxtCtl.Enter,
            TxtCtl.Clear,
    ...
    ChrTalk(
        0x0110,
        (
            '#0111880001V#276F……原来如此。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0110410077V#272F你和这个调皮蛋\n',
            '是一丘之貉啊。',
            TxtCtl.Enter,
        ),
    )
    ...
    ChrTalk(
        0x0110,
        (
            '#0110410079V#272F哼，我说得没错吧。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0110410080V#270F……不过看来，那家伙\n',
            '就是第一个障碍。',
            TxtCtl.Enter,
        ),
    )
